...
namespace SqlSharpener
{
    ...
    public class DataTypeHelper
    {
        ...
        private void LoadDataTypes()
        {
            ...
            dataTypes.Add(DataTypes.@geography, new Dictionary<TypeFormat, string> { { TypeFormat.SqlServerDbType, "geography" }, { TypeFormat.DotNetFrameworkType, "IPoint" }, { TypeFormat.SqlDbTypeEnum, "" }, { TypeFormat.SqlDataReaderSqlType, "" }, { TypeFormat.DbTypeEnum, "" }, { TypeFormat.SqlDataReaderDbType, "" } });
        }
    }
